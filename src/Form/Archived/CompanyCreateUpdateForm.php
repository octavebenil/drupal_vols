...
class CompanyCreateUpdateForm extends FormBase
{
  ...
  public function getFormId() {
    return 'company_add_update_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $id=NULL) {
    ...
    $form['actions']['back'] = [
      '#type' => 'link',
      '#title' => $this->t('Retour'),
      '#url' => \Drupal\Core\Url::fromRoute('vols.company_list'),
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $form_state->setRedirect('vols.company_list');
  }
}
