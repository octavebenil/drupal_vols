...
class VolCreateUpdateForm extends FormBase
{
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $id=NULL) {
    ...
    $form['actions']['back'] = [
      '#type' => 'link',
      '#title' => $this->t('Retour'),
      '#url' => \Drupal\Core\Url::fromRoute('vols.vol_list'),
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $form_state->setRedirect('vols.vol_list');
  }
}
